...
// 프레임 클래스 
class MyFrameClient extends JFrame {
	static final int SCREEN_W = 1000;
	static final int SCREEN_H = 600;
	private GameStartPanelClient gameStartPanel;// 게임 스타트 패널

	private MyFrameClient() {
		init(); 
		gameStartPanel = new GameStartPanelClient(); // 게임 시작 화면 생성 
	...
	private void init() {
		...
		this.setTitle("Client JFream"); // 제목
